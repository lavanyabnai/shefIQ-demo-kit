...
const PROBES = [
  ...
  // Editor + compare pages are client-rendered (Konva ssr:false). Probe shell only.
  ...
  { session: 4, path: "/planograms/beer-v41/compare/beer-v42", expectStatus: 200, markers: ["ShelfIQ"] },
